...
class TaskExecutor:
    ...
    def _run_loop(self, items):
        ...
        if self._task.loop_control:
            ...
            loop_var = templar.template(self._task.loop_control.loop_var) or 'item'
    ...
    def _poll_async_result(self, result, templar, task_vars=None):
        ...
        time_left = self._task.async_value
        while time_left > 0:
            ...
            try:
                ...
                display.vvvv("Exception during async_value poll, retrying... (%s)" % to_text(e))
